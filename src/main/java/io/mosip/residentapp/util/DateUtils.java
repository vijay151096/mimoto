...
import io.mosip.residentapp.constant.DateUtilConstants;
import io.mosip.residentapp.exception.IllegalArgumentException;
...
public final class DateUtils {
    ...
    public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
        ...
        try {
            ...
            throw new io.mosip.residentapp.exception.ParseException(
    ...
    public static Date parseToDate(String dateString, String pattern) {
        if (Objects.isNull(dateString) || Objects.isNull(pattern)) {
            throw new io.mosip.residentapp.exception.NullPointerException(
