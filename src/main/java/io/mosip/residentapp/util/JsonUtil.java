...
import io.mosip.residentapp.exception.FieldNotFoundException;
import io.mosip.residentapp.exception.InstantanceCreationException;
...
public class JsonUtil {
    ...
    public static Object inputStreamtoJavaObject(InputStream stream, Class<?> clazz)
        ...
        try {
            ...
            throw new UnsupportedEncodingException(PlatformErrorMessages.RESIDENT_APP_CMB_UNSUPPORTED_ENCODING.getMessage());
        }
    }
    ...
    public static <T> T[] mapJsonNodeToJavaObject(Class<? extends Object> genericType, JSONArray demographicJsonNode) {
        ...
        try {
            ...
            throw new InstantanceCreationException(PlatformErrorMessages.RESIDENT_APP_SYS_INSTANTIATION_EXCEPTION.getMessage(),
                    e);

        } catch (NoSuchFieldException | SecurityException e) {

            throw new FieldNotFoundException(PlatformErrorMessages.RESIDENT_APP_SYS_NO_SUCH_FIELD_EXCEPTION.getMessage(), e);
