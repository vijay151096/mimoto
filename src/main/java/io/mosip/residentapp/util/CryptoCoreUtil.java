...
public class CryptoCoreUtil {
    ...
    public byte[] symmetricDecrypt(SecretKey key, byte[] data, byte[] nonce, byte[] aad)
        ...
        try {
            ...
            logger.error(PlatformErrorMessages.RESIDENT_APP_INVALID_KEY_EXCEPTION.getCode(),
                    PlatformErrorMessages.RESIDENT_APP_INVALID_KEY_EXCEPTION.getMessage(), e);
            throw new InvalidParamSpecException(PlatformErrorMessages.RESIDENT_APP_INVALID_KEY_EXCEPTION.getCode(),
                    PlatformErrorMessages.RESIDENT_APP_INVALID_KEY_EXCEPTION.getMessage(), e);
