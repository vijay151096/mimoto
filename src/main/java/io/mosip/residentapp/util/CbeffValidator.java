...
import io.mosip.residentapp.constant.CbeffConstant;
import io.mosip.residentapp.entity.BDBInfo;
import io.mosip.residentapp.entity.BIR;
import io.mosip.residentapp.entity.BIRInfo;
import io.mosip.residentapp.entity.RegistryIDType;
import io.mosip.residentapp.entity.SingleAnySubtypeType;
import io.mosip.residentapp.entity.VersionType;
import io.mosip.residentapp.exception.CbeffException;
        ...
        for (BIR bir : birList) {
            if (bir != null) {
                ...
                if (bir.getBdbInfo() != null) {
                    ...
                    // if
                    // (!Long.valueOf(bdbInfo.getFormat().getOrganization()).equals(CbeffConstant.FORMAT_OWNER))
                    // {
                    // throw new CbeffException("Patron Format Owner should be standard specified of
                    // value "
