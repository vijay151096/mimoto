package io.mosip.residentapp.constant;
...
public enum DocumentGeneratorExceptionCodeConstant {
    VC_DECRYPTION_EXCEPTION("KER-VC-001", "Verifiable Credential failed to decrypt"),
     ...
     */
    DocumentGeneratorExceptionCodeConstant(String errorCode, String errorMessage) {
