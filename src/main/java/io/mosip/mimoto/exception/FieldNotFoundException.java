...
public class FieldNotFoundException extends BaseUncheckedException {
    ...
    public FieldNotFoundException(String errorMessage) {
        super(PlatformErrorMessages.MIMOTO_SYS_NO_SUCH_FIELD_EXCEPTION.getCode() + EMPTY_SPACE, errorMessage);
    }
    ...
    public FieldNotFoundException(String message, Throwable cause) {
        super(PlatformErrorMessages.MIMOTO_SYS_NO_SUCH_FIELD_EXCEPTION.getCode() + EMPTY_SPACE, message, cause);
    }
