...
public class InvalidTokenException extends BaseUncheckedException {
    ...
    public InvalidTokenException(String message) {
        super(PlatformErrorMessages.MIMOTO_AUT_INVALID_TOKEN.getCode(), message);
    }
    ...
    public InvalidTokenException(String message, Throwable cause) {
        super(PlatformErrorMessages.MIMOTO_AUT_INVALID_TOKEN.getCode() + EMPTY_SPACE, message, cause);
    }
}
