...
import io.mosip.mimoto.exception.FieldNotFoundException;
import io.mosip.mimoto.exception.InstantanceCreationException;
...
public class JsonUtil {
    ...
    public static Object inputStreamtoJavaObject(InputStream stream, Class<?> clazz)
        ...
        try {
            ...
            throw new UnsupportedEncodingException(PlatformErrorMessages.MIMOTO_CMB_UNSUPPORTED_ENCODING.getMessage());
        }
    }
